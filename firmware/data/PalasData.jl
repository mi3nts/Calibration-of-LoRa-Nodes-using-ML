...
df = DataFrames.DataFrame(CSV.File("C:/Users/sethl/OneDrive/Desktop/data/Palas Data/palasAllGPSJuly2020_palasCarGPS.csv"))
...
function PalasData()
    ...
    #returns array of DataFrames for each month in 2020.
    return return_Palas
end
